		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dummy Liste",
									"targetURL": "#zcmsdummyliste-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcmsdummyliste-display": {
								"semanticObject": "zcmsdummyliste",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcms.dummyliste",
									"url": sap.ui.require.toUrl("zcms/dummyliste")
								}
							}
						}
					}
